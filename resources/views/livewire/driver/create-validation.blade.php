<div class="form-container">
    ...
    <div class="gender dvr">
        ...
        <input class="textbox" wire:model.lazy="gender" id="gender" name="gender" type="text" placeholder="{{ __('Gender') }}">
        @error('gender')
        <span class="error-validation" role="alert">
            {{ $message }}
        </span>
    ...
    <div class="phone dvr">
        ...
        <input class="textbox" wire:model.lazy="phone" id="phone" name="phone" type="text" placeholder="{{ __('Phone') }}">
        @error('phone')
        <span class="error-validation" role="alert">
            {{ $message }}
        </span>
    ...
    <div class="account-name dvr">
        ...
        <input class="textbox" wire:model.lazy="accName" id="accName" name="accName" type="text" placeholder="{{ __('Account Name') }}">
        @error('accName')
        <span class="error-validation" role="alert">
            {{ $message }}
        </span>
    ...
    <div class="account-number dvr">
        ...
        <input class="textbox" wire:model.lazy="accNumber" id="accNumber" name="accNumber" type="text" placeholder="{{ __('Account Number') }}">
        @error('accNumber')
        <span class="error-validation" role="alert">
            {{ $message }}
        </span>
